...
public class Database extends SQLiteOpenHelper {
    ...
    public boolean insertTask(String task_name, String due_date, Double latitude , Double longitude, String Place_name ){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        Log.i(TAG, "inserValues: " + task_name + " date : " + due_date + "latitude: " + latitude + "longitude : "+ longitude + "place : " + Place_name);

        if(task_name == null || due_date == null || latitude == null || longitude == null || Place_name == null)
            return false;
         else
        {
    ...
    boolean IsLocation(String location_name){
        ...
        isAvail = Boolean.valueOf(String.valueOf(cursor.getCount()));
    ...
    public ArrayList<String> getSavedTasks(){
        SQLiteDatabase db = this.getReadableDatabase();
        ArrayList<String> sTasks = new ArrayList<String>();
